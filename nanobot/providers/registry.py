...
Only non-default fields are shown per entry. See ProviderSpec defaults above.
"""
...
PROVIDERS: tuple[ProviderSpec, ...] = (
    ...
    # AiHubMix: strips "anthropic/claude-3" → "claude-3" → "openai/claude-3"
    ProviderSpec(
        name="aihubmix",
        keywords=("aihubmix",),
    ...
    # Zhipu: LiteLLM uses "zai/" prefix. Mirrors key to ZHIPUAI_API_KEY.
    ProviderSpec(
        name="zhipu",
    ...
    # Moonshot: Kimi models. LiteLLM requires MOONSHOT_API_BASE env var.
