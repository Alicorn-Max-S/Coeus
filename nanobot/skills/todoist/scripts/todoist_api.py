...
TODOIST_API_TOKEN = _load_env_value("TODOIST_API_TOKEN")
...
def _check_config():
    ...
    if not TODOIST_API_TOKEN:
        print(
            ...
            "Set it in ~/.nanobot/.env or export it in your shell.\n"
...
def main():
    parser = argparse.ArgumentParser(
        description="Todoist API CLI for nanobot"
    )
